...
8. The repo is managed by uv and renv. Use python 3.10.2 and R 4.4.2. Use uv run python to run python scripts. Before running R scripts, do module load R/4.4.2.
9. We are on HPC with slurm scheduler. Spin up slurm jobs and manage with nextflow for parallel processings. Use "-p free" to use free queue. This is our last project that was orchestrated by nextflow and slurm for your reference: /pub/ddlin/projects/new_rna_seq_results/nextflow_rnaseq/main.nf
